...
\addplot[ultra thick, solid, color=s1] table[x index=0,y index=10,col sep=space, skip first n={2}] {img/nlpb.log};
\addplot[ultra thick, solid, color=s2] table[x index=0,y index=13,col sep=space, skip first n={2}] {img/nlpb.log};
\addplot[ultra thick, solid, color=s3] table[x index=0,y index=16,col sep=space, skip first n={2}] {img/nlpb.log};
\addplot[ultra thick, solid, color=s4] table[x index=0,y index=19,col sep=space, skip first n={2}] {img/nlpb.log};
